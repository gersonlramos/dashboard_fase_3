...
aba_selecionada = st.sidebar.radio(
    "Visualize:",
    ["📊 Executivo", "📈 Gráficos", "📋 Detalhes (em construção)", "⚠️ Impedimentos", "🗺️ Mapa de Migração (em construção)", "📅 Previsão (em construção)"],
...
Mede o tempo que cada história passa nos seguintes status (apenas dias úteis - seg-sex):
- `IN DEVELOPMENT`
- `WAITING CODE REVIEW`
- `IN CODE REVIEW`
- `WAITING TEST`
...
# ── DETALHES ──────────────────────────────────────────────────────────────────
elif aba_selecionada == "📋 Detalhes (em construção)":
